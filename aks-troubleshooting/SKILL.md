...
```bash
kubectl describe service <service-name> -n <namespace> | grep -A 5 "Events"
```
...
## AKS Diagnostics Tool

Use the built-in AKS Diagnose and Solve Problems blade in the Azure Portal, or run:
