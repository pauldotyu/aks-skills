...
| Node pools        | [aks-nodepool-management](./aks-nodepool-management/SKILL.md) | Adding User-mode node pools, migrating workloads off system pools, taints |
...
- **"Create a worker pool" / "migrate workloads off system pool" / "dedicated system node pool" / "nodeSelector"** → aks-nodepool-management
